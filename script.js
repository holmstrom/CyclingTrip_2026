...
const syncManager = {
    ...
    loadData: async function (dataType) {
        ...
        if (!this.isFirebaseAvailable) this.init();
...
// Initialize sync manager immediately
syncManager.init();
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function switchRouteTab(routeKey) {
        ...
        if (!routeLayers[routeKey] && window.syncManager && window.syncManager.isFirebaseAvailable) {
